...
<head>
    ...
    <script>
        ...
        function validarFormulario() {
            ...
            var tipoLocal = document.getElementById('local_tipo').value;
            ...
            if (bloco === "" || lugar === "" || tipoLocal === "" || localIdentificacao === "" || descricao === "" || tipoAssistencia === "") {
...
<body>
    <form id="formulario" action="processar.php" method="post">
        ...
        <div id="etapaDetalhes" style="display:none;">
            ...
            <label for="local_tipo">Tipo de Local:</label>
            <input type="text" id="local_tipo" name="local_tipo" required>

            <label for="local_identificacao">Identificação do Local:</label>
